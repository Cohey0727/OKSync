...
public class AcceleratableButtonSkin extends LabeledSkinBase<AcceleratableButton, ButtonBehavior<AcceleratableButton>> {
    public AcceleratableButtonSkin(AcceleratableButton button) {
        super(button, new ButtonBehavior<AcceleratableButton>(button));
        Label lable = new Label("ABC");
        lable.getStyleClass().add("acceleratable-label");
